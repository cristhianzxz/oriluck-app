...
// ======================================================================
// 📌 SECCIÓN DE TRANSACCIONES Y RECARGAS
// ======================================================================
...
/**
 * 📢 Suscribe un callback a los cambios en los tickets de soporte (en tiempo real).
 * @param {function} callback - Función que recibe la lista de tickets actualizada.
 * @returns {function} Función de 'unsubscribe' para detener el listener.
 */
...
/**
 * Permite a un usuario comprar un ticket y activa el temporizador si se alcanza el umbral.
 * ⚠️ ADVERTENCIA: Esta función es INSEGURA para transacciones de dinero.
 * En producción, la lógica de saldo y transacción debe ir en una Cloud Function.
 */
