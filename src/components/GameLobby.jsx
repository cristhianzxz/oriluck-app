...
const GameLobby = () => {
    ...
    const handleRechargeClick = () => navigate('/recharge');
    ...
    const actionButtons = (
        <>
            ...
            <button onClick={handleRechargeClick} className="bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white font-semibold px-4 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-green-500/25 text-sm">💰 Recargar</button>
            <button onClick={() => handleNavigation('/support')} className="relative bg-blue-600 hover:bg-blue-500 text-white font-semibold px-4 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/25 text-sm">
                🆘 Soporte
                {hasUnreadSupport && (
            ...
            <button onClick={() => handleNavigation('/history')} className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-semibold px-4 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/25 text-sm">📊 Historial</button>
            {userData.isAdmin && (
                <button onClick={handleAdminClick} className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-semibold px-4 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-red-500/25 text-sm">⚙️ Admin</button>
            )}
            <button onClick={handleLogout} className="bg-gradient-to-r from-gray-600 to-gray-500 hover:from-gray-500 hover:to-gray-400 text-white font-semibold px-4 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 text-sm">🚪 Salir</button>
        </>
    );
            ...
            <header className="sticky top-0 z-50 bg-black/40 backdrop-blur-lg border-b border-gold-500/30 shadow-2xl">
                ...
                <div className={`lg:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-96 opacity-100 py-3' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                    <div className="flex flex-col space-y-3 px-4 sm:px-6">
                        ...
                        <button onClick={handleRechargeClick} className="bg-gradient-to-r from-green-600 to-green-500 text-white font-semibold px-4 py-2 rounded-xl text-center shadow-lg shadow-green-500/25">💰 Recargar</button>
                        <button onClick={() => handleNavigation('/support')} className="relative bg-blue-600 text-white font-semibold px-4 py-2 rounded-xl text-center shadow-lg shadow-blue-500/25">
                            🆘 Soporte
                            {hasUnreadSupport && (
                        ...
                        <button onClick={() => handleNavigation('/history')} className="bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold px-4 py-2 rounded-xl text-center shadow-lg shadow-blue-500/25">📊 Historial</button>
                        {userData.isAdmin && (
                            <button onClick={handleAdminClick} className="bg-gradient-to-r from-red-600 to-red-500 text-white font-semibold px-4 py-2 rounded-xl text-center shadow-lg shadow-red-500/25">⚙️ Admin</button>
                        )}
                        <button onClick={handleLogout} className="bg-gradient-to-r from-gray-600 to-gray-500 text-white font-semibold px-4 py-2 rounded-xl text-center">🚪 Salir</button>
                    </div>
                </div>
            </header>
            ...
            <main className="relative z-10 container mx-auto px-4 sm:px-6 py-8 sm:py-12">
                <div className="text-center mb-10 sm:mb-16">
                    ...
                    <p className="text-md sm:text-xl text-gray-300/80 font-light">
                        Bienvenido, <b>{userData.username}</b>. Experimenta la excelencia en gaming.
                    </p>
                </div>
